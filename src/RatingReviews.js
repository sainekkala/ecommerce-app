...
function RatingReviews() {
    ...
    return (
        <div className='container-fluid'>
            ...
            {filteredProduct.ratingReviews && filteredProduct.ratingReviews.map((review, index) => (
                <div className="row my-3">
                    <div className="col-sm my-2">
                        <h5><span className='btn btn-success'>{review.rating}</span> {review.title}</h5>
                        {review.imgSrcs && review.imgSrcs.map(imgSrc => (
                            <img src={imgSrc} width="70px" height="70px" className='me-2'/>
                        ))}
                    </div>
                </div>
            ))}
