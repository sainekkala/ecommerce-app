        ...
        <div className="container-fluid">
            <div className="row">
                <div className="col-sm">
                    <h3>General</h3>
                    <p><b>In the box:</b> {filteredProduct?.detailedSpecifications?.general?.inTheBox}</p>
                    <p><b>Model No:</b> {filteredProduct?.detailedSpecifications?.general?.modelNo}</p>
                    <p><b>Model Name:</b> {filteredProduct?.detailedSpecifications?.general?.modelName}</p>
                    <p><b>Color:</b> {filteredProduct?.detailedSpecifications?.general?.color}</p>
                    <h3>Display Features</h3>
                    <p><b>Display Size:</b> {filteredProduct?.detailedSpecifications?.displayFeatures?.displaySize}</p>
                    <p><b>Resolution:</b> {filteredProduct?.detailedSpecifications?.displayFeatures?.resolution}</p>
                    <p><b>Other Display Features:</b> {filteredProduct?.detailedSpecifications?.displayFeatures?.otherDisplayFeatures}</p>
                </div>
            </div>
        </div>
    )
